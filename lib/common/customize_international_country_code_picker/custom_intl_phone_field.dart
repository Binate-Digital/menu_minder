...
// import 'package:elite_circle_hybrid/global_widgets/customize_international_country_code_picker/custom_country_picker_dialog.dart';
// import 'package:elite_circle_hybrid/global_widgets/customize_international_country_code_picker/custom_helpers.dart';
// import 'package:elite_circle_hybrid/global_widgets/customize_international_country_code_picker/custom_phonenumber.dart';
// import 'package:elite_circle_hybrid/utils/app_colors.dart';
// import 'package:elite_circle_hybrid/utils/app_fonts.dart';
...
//  final  cleanedPhoneNumber = initialPhoneNumber.toString().replaceAll(
...
//     print("Number : $cleanedPhoneNumber");
      ...
      // log("Got phone number: $initialPhoneNumber");
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          //   border: Border.all(
          //     color: widget.enabled ? AppColor.BG_COLOR : Colors.grey.shade300,
          //     width: 1.0,
          ...
          child: TextFormField(
            ...
            validator: (value) {
              ...
              if (!widget.disableLengthCheck) {
                return cleanedPhoneNumber.length >=
                            _selectedCountry.minLength &&
                        cleanedPhoneNumber.length <= _selectedCountry.maxLength
                    ? null
            ...
            // ? null
            // : filterPhoneNumber(_selectedCountry.maxLength.toString()),
