class NearbyRestaurantModel {
  ...
  List<RestaurantResultData>? results;
  String? status;
  ...
  NearbyRestaurantModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      results = <RestaurantResultData>[];
      json['results'].forEach((v) {
        results!.add(RestaurantResultData.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class RestaurantResultData {
  ...
  RestaurantResultData.fromJson(Map<String, dynamic> json) {
...
class Geometry {
  RestaurantLocationModel? location;
  Viewport? viewport;
  ...
  Geometry.fromJson(Map<String, dynamic> json) {
    location = json['location'] != null
        ? RestaurantLocationModel.fromJson(json['location'])
        : null;
    viewport =
...
class RestaurantLocationModel {
  ...
  RestaurantLocationModel({this.lat, this.lng});

  RestaurantLocationModel.fromJson(Map<String, dynamic> json) {
    lat = json['lat'];
    lng = json['lng'];
  }
...
class Viewport {
  RestaurantLocationModel? northeast;
  RestaurantLocationModel? southwest;

  Viewport({this.northeast, this.southwest});

  Viewport.fromJson(Map<String, dynamic> json) {
    northeast = json['northeast'] != null
        ? RestaurantLocationModel.fromJson(json['northeast'])
        : null;
    southwest = json['southwest'] != null
        ? RestaurantLocationModel.fromJson(json['southwest'])
        : null;
  }
