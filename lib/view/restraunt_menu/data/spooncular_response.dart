...
//
//     final spooncularReciepies = spooncularReciepiesFromJson(jsonString);

import 'dart:convert';

SpooncularReciepies spooncularReciepiesFromJson(String str) =>
    SpooncularReciepies.fromJson(json.decode(str));

String spooncularReciepiesToJson(SpooncularReciepies data) =>
    json.encode(data.toJson());

class SpooncularReciepies {
  List<SpooncularRecipeData> recipes;

  SpooncularReciepies({
    required this.recipes,
  });

  factory SpooncularReciepies.fromJson(Map<String, dynamic> json) =>
      SpooncularReciepies(
        recipes: List<SpooncularRecipeData>.from(
            json["recipes"].map((x) => SpooncularRecipeData.fromJson(x))),
      );
...
class SpooncularRecipeData {
  ...
  factory SpooncularRecipeData.fromJson(Map<String, dynamic> json) =>
      SpooncularRecipeData(
