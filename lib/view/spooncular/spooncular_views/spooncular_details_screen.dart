    ...
    if (widget.mealData == null) {
      WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
        context
            ...
            .getSingleRecipeDetail(context, widget.recipieByID!, () {
          widget.mealData =
              ...
              Stack(
                children: [
                  widget.mealData != null &&
                      ...
                      ? MyCustomExtendedImage(imageUrl: widget.mealData!.image!)
                      // Center(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ...List.generate(
                            widget.mealData?.extendedIngredients?.length ?? 0,
                            (index) {
                          final ingrenet =
                              widget.mealData?.extendedIngredients?[index];
                        ...
                        ...List.generate(
                            widget.mealData?.analyzedInstructions?.length ?? 0,
                            (index) {
                          final instruction =
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              ...List.generate(instruction?.steps?.length ?? 0,
                                  (index) {
